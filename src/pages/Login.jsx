  ...
  const FloatingInput = ({ label, type = "text", placeholder, className, disabled }) => {
    ...
    return (
      <div className="relative bg-[#f7f8f9] mb-6">
        ...
        <input type={type} placeholder={placeholder} disabled={disabled} className={`w-full rounded-md border border-gray-300 bg-[#f7f8f9] px-4 py-2 text-sm text-gray-800 focus:outline-none focus:border-purple-600 ${className}`} />
      </div>
    );
  };
